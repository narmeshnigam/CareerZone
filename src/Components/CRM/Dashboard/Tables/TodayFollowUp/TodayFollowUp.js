...
const TodayFollowUp = () => {
    ...
    const followUpWithTodayDate = followUp.filter(follow => follow.nextdate === today);

    const followUpWithTodayDateWithSerialNo = followUpWithTodayDate.map((followUp, index) => ({
        ...followUp,
    ...
    const columns = [
        ...
        { field: 'followUpNo', headerName: 'Follow-Up Number', type: 'number', flex: 1},
