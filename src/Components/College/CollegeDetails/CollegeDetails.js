...
const CollegeDetails = () => {
  ...
  return (
    <div className="College__Details">
      <div
        className="college_details_section1"
        style={{ backgroundImage: ` url(${college.backgroundImg})` }}
      >
        <div className="college_details_heading">{college.name}</div>
      ...
      <div className="college_details_section2">
        <div className="college_detailssection2_content">
          ...
          <div className="college_detailssection2_content1">
            {college.about}
          </div>
        </div>
      </div>
      <div className="college_details_section3">
        <div className="college_details_certifications">
