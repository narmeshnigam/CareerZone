...
//         <label>
//           Name:
//           <input type="text" name="course" value={courseData.course} onChange={(e) => handleChange(e)} />
//         </label>
//         <label>
//           Background Image:
...
const AdminCourses = () => {
  ...
  return (
    <>
      <div style={{ position: 'absolute', backgroundColor: '#00000021' , height: '100vh'}}>
      ...
      <div className={styles['admin-courses__container']}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label>
            Background Image:
            <input type="file" name="backgroundImage" onChange={(e) => handleChange(e)} />
          </label>
          <label>
            About Text:
            <textarea name="aboutText" value={courseData.aboutText} onChange={(e) => handleChange(e)} />
