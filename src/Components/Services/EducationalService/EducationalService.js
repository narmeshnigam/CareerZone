    ...
    <div className='edu__ser__conatiner'>
      ...
      <div className='edu__service__content'>
        ...
        <div className='edu__service__img'>
            <img src='https://franchiseindia.s3.ap-south-1.amazonaws.com/uploads/content/edu/art/5c98b24f61169.jpeg' alt=''/>
        </div>
      </div>
      <div className='edu__service__purpose'>
        <div>
            <img src='https://media.licdn.com/dms/image/C4D12AQHM1k_4F0hcfQ/article-cover_image-shrink_600_2000/0/1611074854633?e=2147483647&v=beta&t=wVBjOd_rdzRKEur7EOOBNHD1Zfcs_NUq7POxCCyKWEY' alt=''/>
        </div>
        <div style={{width:'50%'}}>
            <div className='edu__service__purpose__heading'>Purpose</div>
            <div style={{margin:'1rem 0rem', textAlign:'justify'}}>We aim to provide the best guidance to Indian students. Understanding their unique goals and paths, we help identify suitable courses based on individual strengths and aspirations. This ensures both student and institution satisfaction in the long run.</div>
            <div style={{fontWeight:'600'}}>At THE Career Zone, our purpose is to:</div>
            <div style={{margin:'1rem 0rem', textAlign:'justify'}}>
                <AboutSvg/>
                <span >Ensure that a student is making a well-informed decision by providing complete and accurate information about colleges and universities, courses of study and their study destinations.</span>
            </div>
            <div style={{textAlign:'justify'}}>
                <AboutSvg/>
                <span> Assist students in finding courses that are best suited to them by applying a holistic approach that includes the student's academic, work history, requirements, ambitions, circumstances and strengths.</span>
            </div>
            <div style={{margin:'1rem 0rem', textAlign:'justify'}}>
                <AboutSvg/>
                <span>Guide students through the admission processes for their chosen university.</span>
            </div>
        </div>
      </div>
      <div className='edu__services__work'>
        <div style={{width:'60%'}}>
            <div className='edu__service__purpose__heading'>The Career Zone and its Area of Work</div>
