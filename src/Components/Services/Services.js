      ...
      <div className='services__holder'>
        <div className='education__service__container'>
            ...
            <div className='education__ser__content'>
                ...
                <Link to={'/services/edu_service'}><button onClick={() => scrollTop()}>Read More</button></Link>
            </div>
        </div>
        <div className='education__service__container'>
            ...
            <div className='education__ser__content'>
                ...
                <Link to={'/services/stdCred_service'}><button onClick={() => scrollTop()}>Read More</button></Link>
            </div>
        </div>
      </div>
    </div>
