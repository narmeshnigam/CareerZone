        ...
        <div className="carrer__container__form">
          <div className="carrer__container__form__column">
            ...
            <form>
              ...
              <div>
                <label for="enquire" className="custom-label">
                  Enquire:
                </label>
                <select
                  name="enquire"
          ...
          <div className="carrer__container__form__column">
            ...
            <div className="contact-info">
              ...
              <div>
                ...
                <p>
                  <strong>Address: </strong>&nbsp;&nbsp;511, 5 Floor, Ashiana
                  tower, Brajkishore Path, Near HDFC BANK LTD, Ali Nagar Colony,
                  Salimpur Ahra, Patna, Bihar 800001
                </p>
              </div>
              <div>
                ...
                <p>
                  <strong>Email:</strong>{" "}
                  <a
                    href="mailto:info@thecareerzone.co.in
                  "
                    style={{ color: "#fff" }}
                  >
                    info@thecareerzone.co.in
                  </a>
                </p>
              </div>
              <div>
